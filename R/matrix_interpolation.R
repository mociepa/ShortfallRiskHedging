...
#'
#' @details If asset price is bigger then \eqn{I*ds}, we take value from this element of the matrix where \eqn{asset_price = I*ds}.
#' @examples
...
matrix_interpolation <- function(Value_matrix, ds, dt, I, asset_price, time, End_Time){
  S <- rev(asset_price)
